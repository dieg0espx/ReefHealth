-- Drop existing tables and recreate them without subscriber_id requirement
DROP TABLE IF EXISTS email_clicks;
DROP TABLE IF EXISTS email_opens;

-- Create simplified email_opens table for tracking email opens
...
-- Create simplified email_clicks table for tracking email clicks
