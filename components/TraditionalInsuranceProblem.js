          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="group relative bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="pt-6 sm:pt-8">
                ...
                <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Huge Out-of-Pocket Costs</h4>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Deductibles and co-pays so high that people avoid care entirely, defeating the purpose of having insurance.</p>
              </div>
            </div>
            ...
            <div className="group relative bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="pt-6 sm:pt-8">
                ...
                <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Confusing Rules & Fine Print</h4>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Networks, pre-approvals, surprise bills, and hidden clauses leave you guessing about real costs.</p>
              </div>
            </div>
            ...
            <div className="group relative bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="pt-6 sm:pt-8">
                ...
                <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Inefficient & Wasteful</h4>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Layers of middlemen inflate costs while delaying care and adding bureaucratic red tape.</p>
              </div>
            </div>
            ...
            <div className="group relative bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="pt-6 sm:pt-8">
                ...
                <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">One-Size-Fits-All Plans</h4>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Pricing bias against small businesses and high-headcount industries makes coverage unaffordable.</p>
              </div>
            </div>
            ...
            <div className="group relative bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-main-pink rounded-full flex items-center justify-center shadow-lg">
                  <span className="text-white font-bold text-lg sm:text-xl">6</span>
                </div>
              </div>
              <div className="pt-6 sm:pt-8">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-pink-100 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-pink-200 transition-colors">
