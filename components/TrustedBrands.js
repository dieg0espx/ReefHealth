    ...
    <section className="hidden sm:block py-12 sm:py-16 md:py-20 bg-gray-100 w-full rounded-3xl">
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6 md:px-5">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 px-2 sm:px-4 md:px-6 lg:px-8">
          {/* Left Side - Text */}
          <div className="hidden sm:block flex-1 text-left px-4 sm:px-6 md:px-8 lg:px-12">
               ...
               nation-wide.
                     ...
                     {/* Right Side - Logos and Member Count - Hidden on Mobile */}
           <div className="hidden sm:flex flex-1 items-center justify-end gap-6 sm:gap-8 md:gap-10 lg:gap-12 px-4 sm:px-6 md:px-8 lg:px-12">
                           {/* Company Logos */}
              <div className="flex items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12">
                ...
                <div className="flex items-center">
                  <Image 
                    ...
                    width={500} 
                    height={250} 
                    className="object-contain filter grayscale opacity-70 transform scale-125 sm:scale-150 md:scale-175 lg:scale-200"
                  />
                </div>
