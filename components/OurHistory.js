        ...
        <div className='flex flex-col-reverse lg:flex-row justify-between items-start lg:items-center py-10 sm:py-16 lg:py-20 gap-8 lg:gap-12'>
            <div className="flex flex-col justify-center w-full h-full order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                <button className="bg-[#e03a6a] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold shadow hover:bg-[#d12e5c] transition flex items-center justify-center gap-2 text-sm sm:text-base">Become a Franchisee <i className="bi bi-arrow-up-right"></i></button>
