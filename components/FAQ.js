    ...
    <section className="py-12 sm:py-14 md:py-16 px-4 sm:px-6 bg-white">
      <div className="mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-500 mb-8 sm:mb-10 max-w-xl mx-auto">Got questions about Reef Health? We&rsquo;ve got answers. Find out how we&rsquo;re different from traditional health insurance.</p>
