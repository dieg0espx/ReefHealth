  ...
  return (
    <section className="py-12 sm:py-14 md:py-16 px-4 sm:px-6 bg-white">
      <div className="mx-auto text-center">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6">Meet the People Behind Your Health Benefits</h2>
        <p className="text-base sm:text-lg text-gray-500 mb-8 sm:mb-12 max-w-3xl mx-auto">Our dedicated team of health professionals and benefits specialists work around the clock to ensure you get the care and support you deserve.</p>
