  ...
  return (
    <section id="about" className="pb-8 sm:pb-12 md:pb-16 lg:pb-20 px-4 sm:px-6 md:px-5 bg-white">
      <div className="mx-auto text-center max-w-7xl">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#e03a6a] mb-4 sm:mb-6 md:mb-8 leading-tight">Healthcare is a maze. Our VIP Concierge team clears the path for you.</h2>
