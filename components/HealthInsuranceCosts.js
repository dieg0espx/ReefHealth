          ...
          <div className="flex flex-col lg:flex-row items-stretch min-h-[600px] relative">
            ...
            <div className="flex-1 bg-white p-8 sm:p-12 md:p-16 lg:p-20 flex flex-col justify-center relative">
              ...
              <div className="max-w-2xl mr-16 md:mr-20 lg:mr-24">
                ...
                <p className="text-lg sm:text-xl text-black mb-8 sm:mb-10 leading-relaxed">
                  <span className="font-bold">You deserve better.</span> So do your employees.
                </p>
                 ...
                 <div className="relative w-full max-w-xs lg:max-w-sm xl:max-w-md -translate-x-16 lg:-translate-x-28">
                  ...
                  <div className="relative bg-white rounded-[28px] overflow-hidden shadow-lg aspect-[4/5] z-10">
                    ...
                    />
                                                       ...
                                                       {/* Large Pink Overlapping Shape - Removed since we now have full pink background */}
           </div>
         </div>
       </section>
     </>
