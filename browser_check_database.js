// Browser-compatible script to check database and add sample data
...
window.addSampleSegments = addSampleSegments

console.log('📋 Database check functions loaded!')
console.log('Run checkDatabase() to check the database and add sample data') 