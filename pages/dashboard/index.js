...
export default function Dashboard() {
  ...
  const stats = [
    { name: 'Total Emails Sent', value: '11,388', change: '+15.2%', changeType: 'positive' },
    { name: 'Active Subscribers', value: '2,847', change: '+12.3%', changeType: 'positive' },
    { name: 'Avg Open Rate', value: '23.4%', change: '+1.2%', changeType: 'positive' },
    { name: 'Avg Click Rate', value: '3.7%', change: '-0.5%', changeType: 'negative' },
  ]

  const recentEmailStats = [
    { id: 1, name: 'Welcome Series', sent: '2,847', openRate: '24.5%', clickRate: '3.2%' },
    { id: 2, name: 'Product Launch', sent: '2,847', openRate: '26.1%', clickRate: '4.1%' },
    { id: 3, name: 'Holiday Promotion', sent: '2,847', openRate: '20.0%', clickRate: '3.0%' },
  ]
